...
@interface DJCameraManager () <AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureMetadataOutputObjectsDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
- (void)configureWithParentLayer:(UIView *)parent
{
    ...
    // 浮层框
    [self showFaceImageWithFrame:CGRectMake(100, 100, 200, 200)];
}
...
- (void)initFaceImageWithParent:(UIView *)view;
{
    ...
    self.faceImageView.frame = CGRectMake(15, 50, 300, 300);
...
{
    self.focusImageView.center = _center;
