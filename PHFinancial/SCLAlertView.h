...
@protocol SCLDelegate <NSObject>

- (void)SCLSendNameMessage:(NSString *)message;
- (void)SCLSendIDMessage:(NSString *)message;
- (void)SCLNextDone;
...
@property (nonatomic,weak) id <SCLDelegate> scldelegate;
/** Title Label
 *
